...
public class Main {
    public static void main(String[] args) {
            ...
            String endpoint= "ejercicio7.c36ok8aei8mh.us-east-1.rds.amazonaws.com";
            String usuario = "postgres";
            String password = "12345678";
            String port="5432";
        String urlConexion=" jdbc:postgresql://"+endpoint+":"+port+"/f12006-pg";


        constructors constructor1=(new constructors("mclaren","Mclaren","Marroc","dhfdsfjbdsfds"));
        Piloto piloto2=new Piloto("FATI","Fatine","Bouhrich","2004-07-10","Italy","kjfegfwge");
        Piloto piloto3=new Piloto("PAT","Patri","Hmidi","2000-07-10","Spain","dvdsvdsavfa");
