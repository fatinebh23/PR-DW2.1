...
public class EjemploReal {
    public static void main(String[] args) {
        ...
        //String urlConexion = "jdbc:postgresql://ejercicio7.ctpxbpm90jra.us-east-1.rds.amazonaws.com:5432/f12006";
        ...
        try (Connection conexion = DriverManager.getConnection(urlConexion, usuario, password)) {
            try {
                ...
                //insertamos el segundo piloto
                String insercionSQL2 = "INSERT INTO drivers (code, forename, surname, dob, nationality) VALUES (?, ?, ?, ?, ?)";
                consulta = conexion.prepareStatement(insercionSQL2);
                consulta.setString(1, "SARA");
                consulta.setString(2, "Ana");
                consulta.setString(3, "Viciano");
                consulta.setDate(4, Date.valueOf("1994-09-01"));
                consulta.setString(5, "Spanish");
                consulta.executeUpdate();
